...
This header file defines a template-based ArrayBasedList class implemented 
using a fixed-size NodePool memory manager.

The ArrayBasedList stores nodes using array indices instead of pointers. 
All memory allocation and freeing is performed by the NodePool 
(no dynamic new/delete).
...
public:
    ...
    /*----- Copy Constructor -------------------------------------------------
      Precondition : other is a valid ArrayBasedList.
...
/*----- Constructor ----------------------------------------------------------*/
template <typename ElementType, int NUM_NODES>
ArrayBasedList<ElementType, NUM_NODES>::ArrayBasedList()
...
/*----- Copy Constructor -----------------------------------------------------*/
template <typename ElementType, int NUM_NODES>
ArrayBasedList<ElementType, NUM_NODES>::ArrayBasedList(const ArrayBasedList& other)
    : head(NodePool<ElementType, NUM_NODES>::NULL_VALUE), size(0) {
...
/*----- Assignment Operator --------------------------------------------------*/
template <typename ElementType, int NUM_NODES>
ArrayBasedList<ElementType, NUM_NODES>&
ArrayBasedList<ElementType, NUM_NODES>::operator=(const ArrayBasedList& other) {
...
/*----- isEmpty ---------------------------------------------------------------*/
template <typename ElementType, int NUM_NODES>
bool ArrayBasedList<ElementType, NUM_NODES>::isEmpty() const {
    return (size == 0);
}

/*----- isFull ----------------------------------------------------------------*/
template <typename ElementType, int NUM_NODES>
bool ArrayBasedList<ElementType, NUM_NODES>::isFull() const {
    return (size == NUM_NODES);
}

/*----- getSize ---------------------------------------------------------------*/
template <typename ElementType, int NUM_NODES>
int ArrayBasedList<ElementType, NUM_NODES>::getSize() const {
    return size;
}

/*----- getTop ----------------------------------------------------------------*/
template <typename ElementType, int NUM_NODES>
int ArrayBasedList<ElementType, NUM_NODES>::getTop() const {
    return head;
}

/*----- getFFN ----------------------------------------------------------------*/
template <typename ElementType, int NUM_NODES>
int ArrayBasedList<ElementType, NUM_NODES>::getFFN() {
    return nodePool.getFFN();
}

/*----- display ---------------------------------------------------------------*/
template <typename ElementType, int NUM_NODES>
void ArrayBasedList<ElementType, NUM_NODES>::display() const {
    int cur = head;
    int pos = 1;
...
/*----- search ----------------------------------------------------------------*/
template <typename ElementType, int NUM_NODES>
int ArrayBasedList<ElementType, NUM_NODES>::search(const ElementType& value) const {
    int cur = head;
    int pos = 1;
...
/*----- insertAtPos -----------------------------------------------------------*/
template <typename ElementType, int NUM_NODES>
void ArrayBasedList<ElementType, NUM_NODES>::insertAtPos(const ElementType& value,
                                               int position) {
...
/*----- deleteAtPos -----------------------------------------------------------*/
template <typename ElementType, int NUM_NODES>
void ArrayBasedList<ElementType, NUM_NODES>::deleteAtPos(int position) {
...
/*----- clear -----------------------------------------------------------------*/
template <typename ElementType, int NUM_NODES>
void ArrayBasedList<ElementType, NUM_NODES>::clear() {
    while (!isEmpty())
        deleteAtPos(1);
}
...
/*----- sort ------------------------------------------------------------------*/
template <typename ElementType, int NUM_NODES>
void ArrayBasedList<ElementType, NUM_NODES>::sort() {
    if (size < 2)
        return;
